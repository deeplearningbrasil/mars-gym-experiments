...
--recommender-extra-params '{"n_factors": 50, "metadata_size": 152, "window_hist_size": 10, "vocab_size": 340}' \
--bandit-policy-class mars_gym.model.bandit.FixedPolicy \
--bandit-policy-params '{"arg": 2}' \
--data-frames-preparation-extra-params '{"filter_city": "New York, USA", "window_hist":10}' \

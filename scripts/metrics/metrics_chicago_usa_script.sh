...
## Evalution Script
##
interaction_dir="output/interaction/InteractionTraining/results/*"
for d in $interaction_dir ; do
    task_id="$(echo $d | cut -d'/' -f5)"
...
# 
#     --direct-estimator-extra-params '{"recommender_module_class": "trivago.model.FixedPolicyEstimator"}' \
